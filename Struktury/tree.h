...
public:
	Tree() { root = nullptr; };
	virtual bool isEmpty() { return root == nullptr; };
	virtual bool isRoot(Node *node) { return root == node; };
...
public:
	...
	virtual void setParent(Node *node) override { parent = (TNode *)node; };
	virtual void setLeft(Node *node) override { left = (TNode *)node; };
	virtual void setRight(Node *node) override { right = (TNode *)node; };
